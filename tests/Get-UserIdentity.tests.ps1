...
Describe 'Get-UserIdentity' {
    ...
    InModuleScope PwshZendesk {
        ...
        It 'Requires Id to be positive' {
            { Get-UserIdentity -Context $context -UserId 1 -Id -1 } | Should -Throw
        }

        It 'Requires Id to be Int64' {
            { Get-UserIdentity -Context $context -UserId 1 -Id 'a' } | Should -Throw
        }
        ...
        It 'Requires a UserId to be supplied' {
            ...
            { Get-UserIdentity -Context $context -Id 1 } | Should -Throw
        }
        ...
        It 'Requires UserId to be Int64' {
            { Get-UserIdentity -Context $context -UserId 'a' -Id 1 } | Should -Throw
        }

        It 'List Identities Endpoint' {
            Get-UserIdentity -Context $context -UserId 1
        ...
        It 'Passes on the UserId List' {
            Get-UserIdentity -Context $context -UserId 736088406
            Assert-MockCalled Invoke-Method -Exactly 1 -ParameterFilter { $Path -match '736088406' } -Scope It
        }

        It 'Passes on the UserId Show' {
            Get-UserIdentity -Context $context -UserId 736088406 -Id 1
            Assert-MockCalled Invoke-Method -Exactly 1 -ParameterFilter { $Path -match '736088406' } -Scope It
        }

        It 'Passes on the Id' {
            Get-UserIdentity -Context $context -UserId 1 -Id 736088406
            Assert-MockCalled Invoke-Method -Exactly 1 -ParameterFilter { $Path -match '736088406' } -Scope It
        }
